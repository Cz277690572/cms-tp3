<?php if (!defined('THINK_PATH')) exit(); $config = D('Admin/Basic')->select(); $navs = D('Admin/Menu')->getBarMenus(); ?>
<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <div class="navbar-inverse">
    <div class="container">
      ...
      <ul class="nav navbar-nav navbar-left">
          ...
          <?php if(is_array($navs)): foreach($navs as $key=>$vo): ?><li>
              <a href="/index.php?c=cat&id=<?php echo ($vo["menu_id"]); ?>" <?php if($vo['menu_id'] == $result['catId']): ?>class="curr"<?php endif; ?>><?php echo ($vo["name"]); ?></a>
...
<?php $vo = $result['news'];?>
  ...
  <?php if(is_array($result['advNews'])): $k = 0; $__LIST__ = $result['advNews'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="right-hot">
    <a target="_blank" href="<?php echo ($vo["url"]); ?>"><img src="<?php echo ($vo["thumb"]); ?>" alt="{vo.name}"></a>
